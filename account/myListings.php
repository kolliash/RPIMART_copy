...
if (isset($_GET['image_id'])) {
    ...
    // Fetch all listings created by the logged-in user along with total likes for each listing
    $sql = "
    ...
    if ($result->num_rows > 0) {
        ...
        echo json_encode(['success' => false, 'message' => 'No listings found for this user.']);
    }
